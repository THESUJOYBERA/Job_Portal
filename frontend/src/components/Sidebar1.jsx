                        ...
                        <div className="sidebar">
                            ...
                            <div id="sidebar-bottom">
                                <nav>
                                    ...
                                    <NavLink to={'/ViewJob'} className={'nav'} id="active"><i class="far fa-user"></i> View Jobs <i id="drop" className="fas fa-angle-right"></i></NavLink>
                                    <NavLink to={'/Posting'} className={'nav'}><i class="far fa-user"></i> Add Jobs <i id="drop1" className="fas fa-angle-right"></i></NavLink>
                                    <NavLink to={''} className={'nav'}><i class="far fa-user"></i> Edit Jobs <i id="drop2" className="fas fa-angle-right"></i></NavLink>
